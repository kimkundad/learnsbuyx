        ...
        <SafeAreaProvider style={{ flex: 1, backgroundColor: '#fff' }} >
            ...
            <ScrollView>
                <View style={styles.container}>
                    ...
                    <View>
                        <StepIndicator />
                        <Text style={styles.infoText1}> โปรดเลือกบัญชี </Text>
                    </View>
...
<View style={{ padding: 20 }}>
            <Text style={{ fontSize: 18, fontFamily: 'Prompt_400Regular' }}>วัน-เวลา</Text>
            ...
            {Platform.OS === 'ios' ? (
                ...
                <>
                    ...
                    <View style={styles.inputContainer}>
                        <Text style={styles.label}>หลักฐานการสมัคร</Text>
                        <TouchableOpacity onPress={pickImage} style={styles.uploadButton}>
                            <Text style={styles.uploadText}>{receiptImage ? 'เปลี่ยนรูป' : 'อัพโหลดรูปภาพ'}</Text>
                        </TouchableOpacity>
